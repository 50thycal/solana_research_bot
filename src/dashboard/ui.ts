...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .cat-pump_then_dump { background: rgba(255, 193, 7, 0.15); color: #ffc107; }
  ...
  <script>
    ...
    async function runAnalysis() {
      ...
      try {
        ...
        var catColors = { moon: '#00e676', pump_dump: '#ff9800', pump_then_dump: '#ffc107', rug: '#ff5252', slow_bleed: '#ef9a9a', flat: '#8888aa' };
